...
const links = [
    {
        ...
        icon:
        <svg viewBox="0 0 24 24" className="footer-logo" alt="linedIn">
    ...
    },
    {
        ...
        icon:
        <svg viewBox="0 0 24 24" className="footer-logo" alt="vimeo">
    ...
    },
    {
        ...
        icon:
        <svg viewBox="0 0 24 24" className="footer-logo" alt="instagram">
    ...
    },
    {
        ...
        icon:
        <svg viewBox="0 0 24 24" className="footer-logo" alt="github">
